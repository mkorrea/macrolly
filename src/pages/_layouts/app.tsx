...
export function AppLayout() {
  ...
  return (
    <div className="flex h-screen bg-bg max-h-screen font-default ">
      ...
      <div className="relative flex flex-col w-full overflow-y-auto no-scrollbar bg-white border border-px border-[#DDDDDD] rounded-t-2xl shadow-[0px_0px_24px_#7171711A]  md:mt-2 md:mr-2">
